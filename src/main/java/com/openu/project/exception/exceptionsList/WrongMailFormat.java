...
@Getter
public class WrongMailFormat extends ApiGatewayException {
    public WrongMailFormat() {
        super(ApiGatewayExceptionMessageCode.wrongMailFormat, ApiGatewayExceptionMassage.wrongMailFormat);
    }
}