...
@Getter
public class BadProductName extends ApiGatewayException {
    public BadProductName() {
        super(ApiGatewayExceptionMessageCode.badProductName, ApiGatewayExceptionMassage.badProductName);
    }
}