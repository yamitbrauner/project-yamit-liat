...
@Getter
public class FileAlreadyExist extends ApiGatewayException {
    public FileAlreadyExist() {
        super(ApiGatewayExceptionMessageCode.fileAlreadyExists, ApiGatewayExceptionMassage.fileAlreadyExists);
    }
}