...
@Getter
public class ReservationConfirmError extends ApiGatewayException {
    public ReservationConfirmError() {
        super(ApiGatewayExceptionMessageCode.reservationConfirmError, ApiGatewayExceptionMassage.reservationConfirmError);
    }
}
