...
@Getter
public class PaymentConflictSum extends ApiGatewayException {
    public PaymentConflictSum() {
        super(ApiGatewayExceptionMessageCode.paymentConflictSum, ApiGatewayExceptionMassage.paymentConflictSum);
    }
}
